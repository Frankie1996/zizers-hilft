    ...
    <div id={'map-add-component'}>
      ...
      <div className='ui vertical segment'>
        ...
        >
          ...
          <p>Zur Verhinderung einer weiteren Ausbreitung des Coronavirus, müssen wir unser Leben aktuell so lokal und isoliert wie möglich führen. Das Projekt <strong><i>Zizers hilft!</i></strong> soll Menschen in einer vergleichsweise kleinen Community zusammenbringen, damit einander im Sinne einer Nachbarschaftshilfe geholfen werden kann. Die Idee dahinter stammt vom Tagesanzeiger. Der Web-Entwickler Marc Fehr, der während sechs Monaten pro Jahr in Südafrika arbeitet, hat für seine lokale Community {' '}
          <a
          href='https://www.whozinberg.org' target="_blank"
        >
            whozinberg.org
        </a>{' '}weiterentwickelt, das identisch wie <i>"Zizers hilft!"</i> funktioniert. Dankbarerweise stellt er seinen Programmiercode auf einer <strong>Open Source Repository</strong> von           <a
