...
module.exports = {
  ...
  "sources": {
    "openmaptiles": {
      "type": "vector",
      "url": "https://api.maptiler.com/tiles/v3/tiles.json?key=iypFk9OQirOoWBVPWCE6#"
    }
  },
  "glyphs": "https://api.maptiler.com/fonts/{fontstack}/{range}.pbf?key=iypFk9OQirOoWBVPWCE6",
  "layers": [
    {
      "id": "background",
      "type": "background",
